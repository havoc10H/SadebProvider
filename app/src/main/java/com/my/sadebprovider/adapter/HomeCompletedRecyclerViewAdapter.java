...
public class HomeCompletedRecyclerViewAdapter extends RecyclerView.Adapter<HomeCompletedRecyclerViewAdapter.HomeHolder> {

    private final Context mContext;
    private final Status status;
    public List<ResultItem> list;

    public HomeCompletedRecyclerViewAdapter(Context context, Status status) {
...
//        this.list = list;
    ...
    public HomeCompletedRecyclerViewAdapter.HomeHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ItemHomeBinding binding = ItemHomeBinding.inflate(LayoutInflater.from(viewGroup.getContext()), viewGroup, false);
        return new HomeCompletedRecyclerViewAdapter.HomeHolder(binding);
    }

    public void onBindViewHolder(HomeCompletedRecyclerViewAdapter.HomeHolder holder, int position) {
